      ...
      body: FutureBuilder( // Future 값을 기반으로 위젯 렌더링
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          return Column(
            ...
            children: [
              Expanded(
                child: Stack( // children 위젯들을 순서대로 위로 쌓음
                  children: [
                    renderMainView(), // 화면 전체에 상대방 상대방 카메라가 찍는 영상 배치
                    Align( // 위 좌측에 내 카메라가 찍는 영상 배치
    ...
    if (uid != null) {
      ...
      return AgoraVideoView(
        ...
        controller: VideoViewController(
          ...
          // VideoCanvas에 0을 입력해서 내 영상을 보여줌
  ...
  Widget renderMainView() {
    if (otherUid != null) {
      return AgoraVideoView(
        ...
        // 상대방의 동영상을 AgoraVideoView로 그려낼 수 있음

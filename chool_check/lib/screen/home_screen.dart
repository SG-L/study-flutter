...
class HomeScreen extends StatelessWidget {
  ...
  static final Circle circle = Circle(
    ...
    center: companyLatLng, // 원의 중심이 되는 위치. LatLng 값을 제공
  ...
  Future<String> checkPermission() async {
    final isLocationEnabled = await Geolocator.isLocationServiceEnabled(); // 위치 서비스 활성화 여부
    ...
    return '위치 권한이 허가 되었습니다.'; // 위 모든 조건이 통과되면 위치 권한 허가 완료
  }
}
